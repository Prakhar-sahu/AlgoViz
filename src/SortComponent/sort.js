...
class Sort extends Component {
    ...
    handleRandomize = () => {
        console.log("handle randomize count is %d",this.state.count);
        const rect = getInitialRects(this.state.count);
        const rect2 = rect.slice();
        this.setState({rects:rect,rects2:rect2});
    }
    ...
    handleCountChange = (val) => {
        this.setState({ count: val }, () => {
          console.log("val in handlecountchange %d", val);
          console.log("count in handlecountchange %d", this.state.count);
